...
apk add containerd containerd-openrc cni-plugins
...
cat >>/etc/hosts<<EOF
192.168.10.10 kmaster.k8s.com kmaster
192.168.10.11 node-1.k8s.com node-1
192.168.10.12 node-2.k8s.com node-2
EOF
